...
public class CatalogServiceImpl implements CatalogService {
    ...
    public CommonResponse<List<Product>> getProductListByCategoryId(String categoryId) {
        ...
        if (productList.isEmpty()){
            return CommonResponse.createForSuccessMessage("没有该Id的产品信息");
        }
    ...
    @Override
    public CommonResponse<List<Product>> getProductsByKeyword(String keyword) {
        QueryWrapper<Product> queryWrapper = new QueryWrapper<>();
        queryWrapper.like("name",keyword);

        List<Product> productList = productMapper.selectList(queryWrapper);
        if (productList.isEmpty()){
            return CommonResponse.createForSuccessMessage("没有该关键词的产品信息");
        }
        return CommonResponse.createForSuccess(productList);
    }
    ...
    public CommonResponse<ItemVO> getItemByItemId(String itemid) {
        ...
        if(itemVO == null){
            return CommonResponse.createForSuccessMessage("没有该ItemId的item商品信息");
        }
    ...
    public CommonResponse<List<ItemVO>> getItemsByProductId(String productId) {
        ...
        if (itemList.isEmpty()){
            return CommonResponse.createForSuccessMessage("没有该ProductId的item商品信息");
        }
